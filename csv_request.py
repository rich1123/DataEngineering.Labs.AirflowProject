...
def psql_adp():
    ...
    df = pd.read_csv('/Users/rich/dev/airflow_home/dags/football_data/ADP.csv', delimiter=',')
...
def psql_rb():
    conn = sqlalchemy.create_engine('postgresql+psycopg2://rich:Coder20!@localhost:5432/ff_fb')
    df = pd.read_csv('/Users/rich/dev/airflow_home/dags/football_data/rb_avg.csv', delimiter=',')
...
def psql_wr():
    conn = sqlalchemy.create_engine('postgresql+psycopg2://rich:Coder20!@localhost:5432/ff_fb')
    df = pd.read_csv('/Users/rich/dev/airflow_home/dags/football_data/wr_avg.csv', delimiter=',')
    # with conn.connect() as conn, conn.begin():
...
def psql_qb():
    conn = sqlalchemy.create_engine('postgresql+psycopg2://rich:Coder20!@localhost:5432/ff_fb')
    df = pd.read_csv('/Users/rich/dev/airflow_home/dags/football_data/qb_avg.csv', delimiter=',')
    # with conn.connect() as conn, conn.begin():
...
def psql_te():
    conn = sqlalchemy.create_engine('postgresql+psycopg2://rich:Coder20!@localhost:5432/ff_fb')
    df = pd.read_csv('/Users/rich/dev/airflow_home/dags/football_data/te_avg.csv', delimiter=',')
    # with conn.connect() as conn, conn.begin():
...
def psql_def():
    conn = sqlalchemy.create_engine('postgresql+psycopg2://rich:Coder20!@localhost:5432/ff_fb')
    df = pd.read_csv('/Users/rich/dev/airflow_home/dags/football_data/def_avg.csv', delimiter=',')
    # with conn.connect() as conn, conn.begin():
